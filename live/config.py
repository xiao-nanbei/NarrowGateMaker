...
class MLConfig:
    enabled: bool = True
    feature_protocol: str = "legacy_v12"  # execution_v1 requires the native individual @trade stream
...
BACKTEST_PARAM_SOURCES = (
    ...
    ("feature_protocol", ("ml", "feature_protocol")),
    ...
    ("emergency_close_dd", ("risk", "emergency_close_dd")),
