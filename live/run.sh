...
profile() {
    ...
    echo "NARROWGATE_CPP_QUOTE_POLICY_STAGE=${NARROWGATE_CPP_QUOTE_POLICY_STAGE:-0}"
    echo "NARROWGATE_CPP_SIGNAL_FEATURES=${NARROWGATE_CPP_SIGNAL_FEATURES:-0}"
    echo "NARROWGATE_CPP_LIGHTGBM_INFERENCE=${NARROWGATE_CPP_LIGHTGBM_INFERENCE:-0}"
...
_record_runtime_profile() {
    {
        ...
        echo "cpp_quote_policy_stage=${NARROWGATE_CPP_QUOTE_POLICY_STAGE:-0}"
        echo "cpp_signal_features=${NARROWGATE_CPP_SIGNAL_FEATURES:-0}"
        echo "cpp_lightgbm_inference=${NARROWGATE_CPP_LIGHTGBM_INFERENCE:-0}"
