...
def _bundle_fixture(
    ...
    *,
    ...
    census_receipt["canonical_receipt_sha256"] = backend._document_sha256(
        census_receipt,
        "canonical_receipt_sha256",
    )
    _write_json(
    ...
    builder_receipt: dict[str, object] = {
        "schema_version": (
            "f05_cpp_one_shot_real_day_all_arm_lockstep_v25.builder_preflight.v1"
        ),
    ...
    quick_receipt["canonical_receipt_sha256"] = backend._document_sha256(
        quick_receipt,
        "canonical_receipt_sha256",
    )
    _write_json(
