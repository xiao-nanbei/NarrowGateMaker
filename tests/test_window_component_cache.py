...
def test_bbo_usability_survives_window_and_component_pickle(tmp_path, monkeypatch, usable):
    from models.tick_data_types import HistoricalBBOData
    monkeypatch.setattr(dw, "_record_cache_hit", lambda path: None)
    monkeypatch.setattr(dw, "_register_cache_artifact", lambda path: None)
