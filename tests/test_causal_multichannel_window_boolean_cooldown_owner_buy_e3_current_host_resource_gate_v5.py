...
from research.families.f05_fill_quality_quote_ev.audit import (
    causal_multichannel_window_boolean_cooldown_owner_buy_e3_current_host_resource_gate_v5 as subject,
)
...
def test_schema_surface_and_cycle_break_are_explicit() -> None:
    assert subject.RESOURCE_SCHEMA.endswith("current_host_concurrent_resource_gate.v5")
