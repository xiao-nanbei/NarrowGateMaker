...
void bind_tick_replay(py::module_& m) {
    ...
    py::class_<TickReplayParams>(m, "TickReplayParams")
        .def(py::init<>())
        .def("set_book_observation_clocks", [](TickReplayParams& params,
                const CArray<std::int64_t>& bbo, const CArray<std::int64_t>& l2) {
            if (bbo.ndim() != 1 || l2.ndim() != 1) {
                throw std::invalid_argument("book observation clocks must be one-dimensional");
            }
            params.bbo_observation_ts_us.assign(bbo.data(), bbo.data() + bbo.size());
            params.l2_observation_ts_us.assign(l2.data(), l2.data() + l2.size());
        })
    ...
    py::class_<TraceFillRow>(m, "TraceFillRow")
        ...
        .def_property_readonly("markout_unit", [](const TraceFillRow&) { return "USDC/BTC"; })
        .def_property_readonly("markout_price_source", [](const TraceFillRow&) { return "replay_trade_price_array_may_include_clock_rows"; })
        .def_property_readonly("ev_unit", [](const TraceFillRow&) { return "USDC/BTC"; })
        .def_property_readonly("markout_1s_requested_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[0].requested_end_ms; })
        .def_property_readonly("markout_1s_actual_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[0].actual_end_ms; })
        .def_property_readonly("markout_1s_gap_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[0].gap_ms; })
        .def_property_readonly("markout_1s_status", [](const TraceFillRow& row) { return row.markout_diagnostics[0].status; })
        .def_property_readonly("markout_1s_censor_reason", [](const TraceFillRow& row) { return row.markout_diagnostics[0].censor_reason; })
        .def_property_readonly("markout_1s_fixed_horizon_valid", [](const TraceFillRow& row) { return row.markout_diagnostics[0].fixed_horizon_valid; })
        .def_property_readonly("markout_1s_method", [](const TraceFillRow&) { return "first_replay_price_at_or_after_target"; })
        .def_property_readonly("markout_5s_requested_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[1].requested_end_ms; })
        .def_property_readonly("markout_5s_actual_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[1].actual_end_ms; })
        .def_property_readonly("markout_5s_gap_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[1].gap_ms; })
        .def_property_readonly("markout_5s_status", [](const TraceFillRow& row) { return row.markout_diagnostics[1].status; })
        .def_property_readonly("markout_5s_censor_reason", [](const TraceFillRow& row) { return row.markout_diagnostics[1].censor_reason; })
        .def_property_readonly("markout_5s_fixed_horizon_valid", [](const TraceFillRow& row) { return row.markout_diagnostics[1].fixed_horizon_valid; })
        .def_property_readonly("markout_5s_method", [](const TraceFillRow&) { return "first_replay_price_at_or_after_target"; })
        .def_property_readonly("markout_20s_requested_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[2].requested_end_ms; })
        .def_property_readonly("markout_20s_actual_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[2].actual_end_ms; })
        .def_property_readonly("markout_20s_gap_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[2].gap_ms; })
        .def_property_readonly("markout_20s_status", [](const TraceFillRow& row) { return row.markout_diagnostics[2].status; })
        .def_property_readonly("markout_20s_censor_reason", [](const TraceFillRow& row) { return row.markout_diagnostics[2].censor_reason; })
        .def_property_readonly("markout_20s_fixed_horizon_valid", [](const TraceFillRow& row) { return row.markout_diagnostics[2].fixed_horizon_valid; })
        .def_property_readonly("markout_20s_method", [](const TraceFillRow&) { return "first_replay_price_at_or_after_target"; })
        .def_property_readonly("markout_30s_requested_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[3].requested_end_ms; })
        .def_property_readonly("markout_30s_actual_end_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[3].actual_end_ms; })
        .def_property_readonly("markout_30s_gap_ms", [](const TraceFillRow& row) { return row.markout_diagnostics[3].gap_ms; })
        .def_property_readonly("markout_30s_status", [](const TraceFillRow& row) { return row.markout_diagnostics[3].status; })
        .def_property_readonly("markout_30s_censor_reason", [](const TraceFillRow& row) { return row.markout_diagnostics[3].censor_reason; })
        .def_property_readonly("markout_30s_fixed_horizon_valid", [](const TraceFillRow& row) { return row.markout_diagnostics[3].fixed_horizon_valid; })
        .def_property_readonly("markout_30s_method", [](const TraceFillRow&) { return "first_replay_price_at_or_after_target"; })
