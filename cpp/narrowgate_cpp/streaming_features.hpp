...
public:
    ...
    [[nodiscard]] std::vector<Bar1s> update_weighted_batch(
        ArrayView<std::int64_t> ts_ms,
        ArrayView<double> prices,
        ArrayView<double> quantities,
        ArrayView<std::uint8_t> is_buyer_maker,
...
private:
    void apply_trade(
        Bar1s& bar, double price, double qty, bool is_buyer_maker,
        std::int64_t run_len, std::int64_t trade_count
    );
    void update_one(
        std::int64_t ts_ms,
        double price,
    ...
    std::int64_t last_trade_run_len_ = 0;
    std::int64_t last_trade_ts_ms_ = 0;
};
...
public:
    ...
    void update_trade_weighted_batch(
        ArrayView<std::int64_t> ts_ms,
        ArrayView<double> prices,
        ArrayView<double> quantities,
        ArrayView<std::uint8_t> is_buyer_maker,
