...
def planned_files(pairs: list[tuple[Path, Path]]) -> list[dict]:
    ...
    for staged, target in pairs:
        ...
        files.append({"staged": str(staged), "before": identity(target), "after": identity(staged)})
