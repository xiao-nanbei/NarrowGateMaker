...
def main() -> int:
    ...
    parser.add_argument("--region", default="aws-ap-northeast-1-tokyo")
    parser.add_argument("--instance", default="aws-t3-medium")
    parser.add_argument("--os-label", default="amazon-linux-2023")
    parser.add_argument("--cpu-label", default="2-vcpu")
    parser.add_argument("--memory-label", default="4-GiB")
