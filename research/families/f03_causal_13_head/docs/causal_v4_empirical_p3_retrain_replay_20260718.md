...
> Retirement notice (2026-09-13): the input bundle `features_btcusdc_causal_v3_empirical_p3_20260718` is retired for current training and replay: it contains the documented five-minute metrics time leakage on 2026-07-12, 2026-07-14, and 2026-07-15 described below. Retain this report only as historical reference; do not reuse its withdrawn test/all-panel ML or BUY-scorer values in the new round. The specific defect does not invalidate the earlier train/validation dates or independently timed P3 calibration by itself. See the [maintained retirement summary](../README.md#retired-causal-v3-feature-bundle-documented-time-leakage). This is a documentation update, not a physical deletion, rerun, or replacement validation.
