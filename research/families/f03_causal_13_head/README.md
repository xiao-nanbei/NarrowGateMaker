...
Status: active operational and backtest baseline. Causal-v12 semantics-v6 is the owner-promoted rolling control with q90 and BUY fill-selection actions suspended; q90 shadow remains enabled. Independent research confirmation and the campaign-q10 gate remain unresolved.
...
The sole current operational authority is the mutable [`operational_baseline_current.json`](../f10_live_replay_attribution/docs/operational_baseline_current.json) pointer. It resolves to immutable [`operational_baseline_identity_20260808_v10.json`](../f10_live_replay_attribution/docs/operational_baseline_identity_20260808_v10.json). v10 keeps causal-v12 ML ON, q90 shadow ON/action OFF, BUY fill-selection shadow OFF/action OFF, and the active depth-imbalance asymmetry. It retires closed observation streams without changing the economic quote path relative to v9. The v8 snapshot remains the historical quote-snapshot atomicity release, not the current identity; v9, v8, v7, v6, v5, and preceding canary identities remain frozen historical evidence.
