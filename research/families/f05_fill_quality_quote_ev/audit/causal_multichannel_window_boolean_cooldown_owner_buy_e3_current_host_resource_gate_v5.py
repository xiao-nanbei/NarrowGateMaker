"""Current-host resource gate v5 for the external-venues-disabled BUY E3 path.
...
RESOURCE_SCHEMA: Final = f"{OWNER_IDENTITY}.current_host_concurrent_resource_gate.v5"
