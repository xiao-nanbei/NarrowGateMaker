"""Current-host resource gate v7 for the external-venues-disabled BUY E3 path.
...
PROCESS_SCHEMA: Final = f"{OWNER_IDENTITY}.current_host_process_snapshot.v5"
PROCESS_STATUS: Final = "external_venues_disabled_runtime_process_snapshot_complete"
PROCESS_CANONICAL_FIELD: Final = "canonical_process_snapshot_sha256"
BENCHMARK_SCHEMA: Final = f"{OWNER_IDENTITY}.exact_four_file_host_benchmark.v5"
BENCHMARK_STATUS: Final = "external_venues_disabled_four_file_aggregate_benchmark_passed"
BENCHMARK_CANONICAL_FIELD: Final = "canonical_benchmark_receipt_sha256"
RESOURCE_SCHEMA: Final = f"{OWNER_IDENTITY}.current_host_concurrent_resource_gate.v7"
