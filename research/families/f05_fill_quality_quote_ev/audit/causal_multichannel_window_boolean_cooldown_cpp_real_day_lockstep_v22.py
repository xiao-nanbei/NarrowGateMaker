...
IDENTITY = "f05_cpp_one_shot_real_day_all_arm_lockstep_v25"
SCHEMA_VERSION = f"{IDENTITY}.receipt.v1"
QUALIFICATION_DAY_INDEX = 0
WORKER_TOKENS = 10
EXPECTED_PANEL_OPPORTUNITIES = 3_516
BUILDER_PREFLIGHT_IDENTITY = "f05_cpp_target_predicate_builder_all_opportunity_zero_economic_v25"
...
QUICK_PREFLIGHT_IDENTITY = "f05_cpp_first_opportunity_all_arm_lockstep_v25"
...
def _run_first_opportunity_all_arm_preflight(
    *,
    ...
    quick_staging = output_path.parent / ".cpp-lockstep-v25-quick-staging"
...
def _run_lockstep_impl(
    ...
    *,
    ...
    stage["value"] = "verify_v24_to_v25_invariance"
    invariance_receipt = orchestrator._validate_v24_v25_invariance_receipt(
        manifest_path,
    ...
    staging_root = output_path.parent / ".cpp-lockstep-v25-staging"
