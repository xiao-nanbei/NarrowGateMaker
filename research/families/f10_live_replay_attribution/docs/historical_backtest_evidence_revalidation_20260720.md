...
> Retirement notice (2026-09-13): `features_btcusdc_causal_v3_empirical_p3_20260718` is retired for current training and replay because of the documented metrics time leakage on 2026-07-12, 2026-07-14, and 2026-07-15. Metrics were exposed at the start of their five-minute interval instead of its causal end. Test/all-122 ML results and BUY-scorer bucket results derived from that bundle remain withdrawn, including cross-fitting effects beyond those three report rows. Unaffected train/validation dates and independently timed P3 calibration are not invalidated by this defect alone. See the [maintained retirement summary](../../f03_causal_13_head/README.md#retired-causal-v3-feature-bundle-documented-time-leakage). Historical findings below are not current input instructions; this notice neither deletes data nor validates a replacement.
