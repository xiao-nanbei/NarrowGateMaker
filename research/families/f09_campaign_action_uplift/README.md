...
This family owns packages 8, 12 in the [unified plan](../../RECOMPUTE_407.md); see the [machine-readable work list](../../recompute_407.json). A plan is not an execution receipt.

## Implementation and new results

Timed action/OPE APIs exist. Paired simulation needs no fictional propensity; OPE needs actual supported behavior logs. New action grids and full-path evaluation remain pending.
