...
Status: keep/cancel, net-hazard, and dynamic-fill M0 research families are closed. The BUY q90 action is now suspended in production while its shadow model remains active; this baseline-integrity disposition does not reopen these prediction or action families.
...
F10's latest live diagnostic found an observational association between order age and weaker approximate 10-second fill value. Because active age is selected by the realized market and baseline policy, that association is not KEEP versus CANCEL/REPLACE uplift and does not reopen this family.
...
The production suspension is recorded in [`buy_q90_action_suspension_operational_release_v1`](../f10_live_replay_attribution/docs/buy_q90_action_suspension_operational_release_v1_20260802.md). It preserves shadow data and causal-v12 ML while granting no q90 action or economic authority.
