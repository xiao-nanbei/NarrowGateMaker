    ...
    for day in days:
        ...
        try:
            out = qc.compute_quote_core_batch_depth_cpp(
                ...
                best_bid=best_bid,
                best_ask=best_ask,
                touch_conditioned_up_probability_10000ms=pred_dir,
                absolute_price_variance_rate_10000ms=pred_vol,
                touch_conditioned_price_change_fraction_10000ms=pred_ret,
                tox_bid=tox_bid,
                tox_ask=tox_ask,
                mo_ema_bid=mo_bid,
                mo_ema_ask=mo_ask,
