...
import type { QualityDateWindow } from "./traceSeries";
...
export function DataQuality({
  ...
  const [dateWindow, setDateWindow] = useState<QualityDateWindow | null>(null);
      ...
      .then((value) => {
        if (!controller.signal.aborted) {
          ...
          setDateWindow((current) =>
            initialQualityWindow(current, value.calendar),
          );
          setNode((current) =>
  ...
  return (
    <section className="panel quality-panel">
      ...
      <div className="result-body">
        <div className="quality-actions" role="group" aria-label="数据层">
          ...
          <button
            ...
            onClick={() => {
              if (catalog?.calendar) {
                setDateWindow({
                  start: catalog.calendar.start_day,
                  end: catalog.calendar.end_day,
                });
              }
            }}
          >
        ...
        {!valid && (dateWindow !== null || catalog !== null) && (
          <div className="notice error" role="alert">
