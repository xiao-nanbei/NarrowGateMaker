...
SUPERSEDED_V4_ACTIVE_CONFIG_SHA256: Final = (
    transport.resource_v5.config_successor.OLD_ACTIVE_CONFIG_SHA256
)
...
def _validate_config_correction_content(value: Any) -> dict[str, Any]:
    ...
    successor = transport.resource_v5.config_successor
    if (
...
def _validate_portable_v5(
    ...
    *,
    ...
    expected_receipt_identity = {
        "config_correction": (
            transport.resource_v5.config_successor.SCHEMA_VERSION,
            transport.resource_v5.config_successor.STATUS,
            transport.resource_v5.config_successor.CANONICAL_FIELD,
        ),
